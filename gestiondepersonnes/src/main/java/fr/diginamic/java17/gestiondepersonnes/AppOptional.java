...
//Concaténation à partir de notre Objet Optional<Personne>
...
//avec else
		...
		/*
		 * if(op.isEmpty()) { System.out.println("Personne non trouvée"); }
		 * if(op.isPresent()) { System.out.println("Personne trouvée : "+ op.get()); }
		 */
	}
}